    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="mb-8">
        <div class="flex items-center gap-2 mb-4">
          ...
          <div class="flex items-center gap-1">
            ...
            <span
              class="text-sm font-bold bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent uppercase tracking-wider">Pro</span>
        ...
        <h1 class="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-purple-600">
          Professional Certifications</h1>
        <p class="mt-2 text-lg text-gray-600">Validate your expertise with AI Pro's industry-recognized certifications
        </p>
      </div>
      ...
      <div v-else class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <div v-for="exam in filteredExams" :key="exam.id"
          ...
          <!-- Exam Header -->
          <div
            class="relative h-48 bg-gradient-to-r from-indigo-500 to-purple-600 p-6 flex items-center justify-center">
