                    ...
                    <div class="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
                        <div class="flex items-center flex-shrink-0 px-4 mb-5">
                            ...
                            <svg class="h-8 w-auto mr-2" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M25 2L2 13L25 24L48 13L25 2Z" fill="#4F46E5"/>
                            ...
                            <div class="flex flex-col">
                                <span class="text-xl font-bold text-indigo-600">ExamPro</span>
                                <span class="text-xs text-gray-500">Learning Management System</span>
                            </div>
                        </div>
                        <nav class="mt-5 flex-1 px-2 bg-white space-y-1">
                            ...
                            <router-link :to="{ name: 'admin.users.index' }"
                                class="group flex items-center px-2 py-2 text-sm font-medium rounded-md" :class="[
                                    $route.name && $route.name.startsWith('admin.users')
                                        ? 'bg-indigo-50 text-indigo-600'
                                        : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900'
                                ]">
                                <svg class="mr-3 flex-shrink-0 h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none"
                            ...
                            <!-- Exams -->
                            <router-link :to="{ name: 'admin.exams.index' }"
                                class="group flex items-center px-2 py-2 text-sm font-medium rounded-md" :class="[
                                    $route.name && $route.name.startsWith('admin.exams')
                                        ? 'bg-indigo-50 text-indigo-600'
                                        : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900'
                                ]">
                                <svg class="mr-3 flex-shrink-0 h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none"
                            ...
                            <router-link :to="{ name: 'admin.questions.index' }"
                                class="group flex items-center px-2 py-2 text-sm font-medium rounded-md" :class="[
                                    $route.name && $route.name.startsWith('admin.questions')
                                        ? 'bg-indigo-50 text-indigo-600'
                                        : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900'
                                ]">
                                <svg class="mr-3 flex-shrink-0 h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none"
                            ...
                            <!-- Certificates -->
                            <router-link :to="{ name: 'admin.certificates.index' }"
                                class="group flex items-center px-2 py-2 text-sm font-medium rounded-md" :class="[
                                    $route.name && $route.name.startsWith('admin.certificates')
                                        ? 'bg-indigo-50 text-indigo-600'
                                        : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900'
                                ]">
                                <svg class="mr-3 flex-shrink-0 h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none"
                            ...
                            <!-- Activity Logs -->
                            <router-link to="/admin/activity-logs"
                                class="group flex items-center px-2 py-2 text-sm font-medium rounded-md" :class="[
                                    $route.path.includes('/activity-logs')
                            ...
                            <router-link to="/admin/resources"
                                class="group flex items-center px-2 py-2 text-sm font-medium rounded-md" :class="[
                                    $route.name.startsWith('admin.resources')
                                        ? 'bg-indigo-50 text-indigo-600'
                                        : 'text-gray-600 hover:bg-gray-50'
                                ]">
                                <svg class="mr-3 h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none"
                                    viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <div class="flex-shrink-0 group block w-full">
                            <div class="flex items-center">
                                <div v-if="authStore.user?.avatar">
                                    <img class="h-8 w-8 rounded-full" :src="authStore.user.avatar_url" alt="">
                                </div>
                                <div v-else
                ...
                <div class="relative flex-1 flex flex-col max-w-xs w-full bg-white">
                    ...
                    <div class="flex-1 h-0 pt-5 pb-4 overflow-y-auto">
                        <div class="flex-shrink-0 flex items-center px-4">
                            <span class="text-xl font-bold text-gray-900">ExamPro Admin</span>
                        </div>
