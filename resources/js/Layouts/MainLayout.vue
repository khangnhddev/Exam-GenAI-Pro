          ...
          <div class="flex items-center gap-8"> <!-- Increased gap -->
            ...
            <div class="flex-shrink-0">
              <router-link to="/" class="flex items-center gap-2">
                <!-- Replace the SVG logo with your image -->
                <img 
                  src="/images/JVITTechs-Logo.png" 
                  alt="JVITTechs Logo" 
                  class="h-10 w-auto"
                />
                <!-- Remove the text part if it's included in your logo image -->
                <!-- If you still want to keep the AI Pro text, leave this part -->
